...
if search_choice == 'Top Stories':
    ...
    if search_choice_sub == 'Bengaluru':
            dict_rss_news_feeds = { 'Hindustan Times': "https://www.hindustantimes.com/feeds/rss/cities/bengaluru-news/rssfeed.xml",
                                    'Times of India': "https://timesofindia.indiatimes.com/rssfeeds/-2128833038.cms",
                                    'One India': "https://kannada.oneindia.com/rss/feeds/oneindia-kannada-fb.xml"}
